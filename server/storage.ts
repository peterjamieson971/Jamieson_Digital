...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this.profile = {
      ...
      previousRole2: "Chief Technology Officer at Department of Culture & Tourism (DCT) Abu Dhabi - Spearheaded digital government strategy implementation for 2,000+ employees. Delivered Abu Dhabi's first full Azure and M365 migration, with integrated E5 telephony. Implemented SAP SuccessFactors and Microsoft Dynamics 365 across HR and CRM functions.",
      email: "peter@apj.me",
