...
export default function ArticlesSection() {
  ...
  return (
    <section id="articles" className="py-12 md:py-20 px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50 section-fade">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-apple-text tracking-tight mb-4">Articles &amp; Publications</h2>
            ...
            <div key={index} className="group relative">
              <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 p-6 md:p-8 h-full flex flex-col border border-gray-100/50">
                ...
                <div className="text-center mb-6 md:mb-8">
                  <div className="w-16 md:w-20 h-16 md:h-20 rounded-3xl flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-md group-hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-gray-50 to-white border border-gray-100">
